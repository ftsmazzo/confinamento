(function($){
    ...
    var i18n = {
        ...
        pt_BR: {
            ...
            errorSizeLimit: 'O arquivo "%fileName%" excede o limite de tamanho: (%sizeLimit%)',
            errorFileType: 'O Arquivo "%fileName%" é inválido',
            errorOldBrowser: 'Seu navegador não pode realizar upload de arquivos. Atualize-o para a versão mais recente'
        }
    };
