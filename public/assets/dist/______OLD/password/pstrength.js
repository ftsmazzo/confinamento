...
(function(a) {
    a.extend(a.fn, {pstrength:function(b) {
        var b = a.extend({verdects:["Muito fraca","Fraca","Média","Forte","Muito forte"],colors:["#f00","#c06","#f60","#3d0","#30cb02"],scores:[10,15,30,40],common:["password","sex","god","123456","123","liverpool","letmein","qwerty","monkey"],minchar:5}, b);
        return this.each(function() {
            ...
            a(this).parent().after(c); //pmd-input
            // a(this).after(c); //default input
