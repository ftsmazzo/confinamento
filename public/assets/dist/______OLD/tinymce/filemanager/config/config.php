...
require __DIR__."/../../../../../lib/config/config.php";
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => '/'.$config["path"].'/'.$config["path_uploads"].'/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../../../../../'.$config["path_uploads"].'/',
    ...
    |
    */
    'thumbs_base_path' => '../../../../../'.$config["path_uploads"].'/',
    ...
    |
    */
    'thumbs_upload_dir' => '/'.$config["path_uploads"].'/',
