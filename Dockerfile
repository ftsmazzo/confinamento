...
# Document root = raiz do projeto (index.php na raiz)
...
# Copia o código (vendor fica de fora via .dockerignore e é instalado no build)
...
# Garante pastas graváveis em runtime
