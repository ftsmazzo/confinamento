...
class LoginController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $configLayout = Config::get("app.sceneries.admin.layout");

        $this->loginViewData = [
            "template" => "fluid", // box ou fluid
            "logo" => layout((string) ($configLayout["logo_login"] ?? "logo.svg")),
            "logo_height" => (int) $configLayout["logo_login_height"],
